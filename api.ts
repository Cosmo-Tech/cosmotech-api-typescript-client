 ...
 * Cosmo Tech Platform API
 *
 * The version of the OpenAPI document: 5.0.0-rc6
...
export interface Runner {
    ...
    /**
     * definition of resources needed for the runner run
     */
...
export const DatasetApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        queryData: async (organizationId: string, workspaceId: string, datasetId: string, datasetPartId: string, selects?: Array<string>, sums?: Array<string>, avgs?: Array<string>, counts?: Array<string>, mins?: Array<string>, maxs?: Array<string>, offset?: number, limit?: number, groupBys?: Array<string>, orderBys?: Array<string>, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'organizationId' is not null or undefined
            ...
            if (selects) {
                localVarQueryParameter['selects'] = selects;
            }
            ...
            if (avgs) {
                localVarQueryParameter['avgs'] = avgs;
            }
            ...
            if (mins) {
                localVarQueryParameter['mins'] = mins;
            }

            if (maxs) {
                localVarQueryParameter['maxs'] = maxs;
            }
            ...
            if (groupBys) {
                localVarQueryParameter['groupBys'] = groupBys;
            }
...
export const DatasetApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async queryData(organizationId: string, workspaceId: string, datasetId: string, datasetPartId: string, selects?: Array<string>, sums?: Array<string>, avgs?: Array<string>, counts?: Array<string>, mins?: Array<string>, maxs?: Array<string>, offset?: number, limit?: number, groupBys?: Array<string>, orderBys?: Array<string>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<File>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.queryData(organizationId, workspaceId, datasetId, datasetPartId, selects, sums, avgs, counts, mins, maxs, offset, limit, groupBys, orderBys, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const DatasetApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        queryData(organizationId: string, workspaceId: string, datasetId: string, datasetPartId: string, selects?: Array<string>, sums?: Array<string>, avgs?: Array<string>, counts?: Array<string>, mins?: Array<string>, maxs?: Array<string>, offset?: number, limit?: number, groupBys?: Array<string>, orderBys?: Array<string>, options?: RawAxiosRequestConfig): AxiosPromise<File> {
            return localVarFp.queryData(organizationId, workspaceId, datasetId, datasetPartId, selects, sums, avgs, counts, mins, maxs, offset, limit, groupBys, orderBys, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Replace existing dataset parts of a Dataset
