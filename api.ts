...
export const ScenariorunApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        deleteHistoricalDataWorkspace: async (organizationId: string, workspaceId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'organizationId' is not null or undefined
...
export const ScenariorunApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async deleteHistoricalDataWorkspace(organizationId: string, workspaceId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteHistoricalDataWorkspace(organizationId, workspaceId, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
...
export const ScenariorunApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        deleteHistoricalDataWorkspace(organizationId: string, workspaceId: string, options?: any): AxiosPromise<void> {
            return localVarFp.deleteHistoricalDataWorkspace(organizationId, workspaceId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Delete all historical ScenarioRuns for the Scenario
...
export class ScenariorunApi extends BaseAPI {
     ...
     * @memberof ScenariorunApi
     */
    public deleteHistoricalDataWorkspace(organizationId: string, workspaceId: string, options?: AxiosRequestConfig) {
        return ScenariorunApiFp(this.configuration).deleteHistoricalDataWorkspace(organizationId, workspaceId, options).then((request) => request(this.axios, this.basePath));
    }
...
export const TwingraphApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        _delete: async (organizationId: string, graphId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/organizations/{organization_id}/delete/{graphId}`
                .replace(`{${"organization_id"}}`, encodeURIComponent(String(organizationId)))
        ...
        importGraph: async (organizationId: string, twinGraphImport: TwinGraphImport, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/organizations/{organization_id}/import`
                .replace(`{${"organization_id"}}`, encodeURIComponent(String(organizationId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        query: async (organizationId: string, twinGraphQuery: TwinGraphQuery, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'organizationId' is not null or undefined
            ...
            const localVarPath = `/organizations/{organization_id}/query`
                .replace(`{${"organization_id"}}`, encodeURIComponent(String(organizationId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const TwingraphApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async query(organizationId: string, twinGraphQuery: TwinGraphQuery, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.query(organizationId, twinGraphQuery, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const TwingraphApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        query(organizationId: string, twinGraphQuery: TwinGraphQuery, options?: any): AxiosPromise<string> {
            return localVarFp.query(organizationId, twinGraphQuery, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class TwingraphApi extends BaseAPI {
     ...
     * @memberof TwingraphApi
     */
    public query(organizationId: string, twinGraphQuery: TwinGraphQuery, options?: AxiosRequestConfig) {
        return TwingraphApiFp(this.configuration).query(organizationId, twinGraphQuery, options).then((request) => request(this.axios, this.basePath));
    }
}
